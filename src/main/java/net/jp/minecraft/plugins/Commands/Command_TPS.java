...
import net.jp.minecraft.plugins.Listener.Listener_TicksPerSecond_1_9_R2;
...
public class Command_TPS implements CommandExecutor {
    ...
    private static String tps1() {
        return Listener_TicksPerSecond_1_9_R2.doubleToString(Listener_TicksPerSecond_1_9_R2.getTps(1));
    }

    private static String tps2() {
        return Listener_TicksPerSecond_1_9_R2.doubleToString(Listener_TicksPerSecond_1_9_R2.getTps(2));
    }

    private static String tps3() {
        return Listener_TicksPerSecond_1_9_R2.doubleToString(Listener_TicksPerSecond_1_9_R2.getTps(3));
    }
}
