...
import net.jp.minecraft.plugins.Listener.Listener_TicksPerSecond_1_9_R1;
...
public class Command_TPS implements CommandExecutor {
    ...
    private static String tps1() {
        return Listener_TicksPerSecond_1_9_R1.doubleToString(Listener_TicksPerSecond_1_9_R1.getTps(1));
    }

    private static String tps2() {
        return Listener_TicksPerSecond_1_9_R1.doubleToString(Listener_TicksPerSecond_1_9_R1.getTps(2));
    }

    private static String tps3() {
        return Listener_TicksPerSecond_1_9_R1.doubleToString(Listener_TicksPerSecond_1_9_R1.getTps(3));
    }
}
